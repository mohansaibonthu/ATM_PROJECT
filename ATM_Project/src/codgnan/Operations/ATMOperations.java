...
public class ATMOperations {
	...
	public static void main(String[] args) throws NotAOperatorException, IncorrectPinLimitReachedException {
		...
		dataBase.put((long) 222222222, new AxisDebitCard(222222222,"Ramya",500000.0,2222));
		dataBase.put((long) 111111111, new HDFCDebiteCard(11111111,"sai",700000.0,1111));
		dataBase.put((long) 333333333, new SBIDebitCard(333333333,"Sri",8500000.0,3333));
